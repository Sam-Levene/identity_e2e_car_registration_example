...
import com.identitye2e.reporting.ReportGenerator;
import com.identitye2e.utils.HtmlTags;
...
public class BrowserActions implements BrowserActionsInterface {
    ...
    public BrowserActions changeTab(Integer index) {
    ...
    public List<WebElement> getFocusedList() {
        return focusedList;
    }
